...
public class When_sending_failed_recieved {
	...
	public void setUp() {
		...
		event = new OcbcFileSendingFailed(FILE_NAME, "Error Message", "Stacktrace");
	}
	...
	public void should_move_file_from_incoming_to_processing() throws IOException {
		...
		houseKeepingService.moveOnSendingFailed(event);
